...
class OrderPushNotificationBuilder
{
    ...
    private function pending($fcmTokenArray, $orderId)
    {
    ...
    private function confirmation($fcmTokenArray, $orderId)
    {
    ...
    private function processing($fcmTokenArray, $orderId)
    {
    ...
    private function outForDelivery($fcmTokenArray, $orderId)
    {
    ...
    private function delivered($fcmTokenArray, $orderId)
    {
    ...
    private function canceled($fcmTokenArray, $orderId)
    {
    ...
    private function rejected($fcmTokenArray, $orderId)
    {
    ...
    private function returned($fcmTokenArray, $orderId)
    {
