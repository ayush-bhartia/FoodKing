            ...
            <div class="modal-body">
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-6">
                            <label class="db-field-title required" for="fixed">
                                {{ $t("label.type") }}
                            </label>
                            <div class="db-field-radio-group">
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.taxTypeEnum.FIXED" v-model="props.form.type" id="fixed"
                                ...
                                <div class="db-field-radio">
                                    <div class="custom-radio">
                                        <input :value="enums.taxTypeEnum.PERCENTAGE" v-model="props.form.type"
