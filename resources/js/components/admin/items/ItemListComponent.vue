        ...
        <div class="col-3">
            <div class="db-card">
                <div class="db-card-header border-none">
                    <h3 class="db-card-title">{{ $t('label.category') }}</h3>
                </div>

                <div class="h-0 overflow-hidden md:h-auto md:overflow-auto transition-all duration-300"
                    v-for="categoryItem in itemCategories" :key="categoryItem">
                    <nav class="db-card p-3">
                        <form @submit.prevent="search">
                            <button type="submit" class="router-link-exact-active db-tab-btn"
                                @click="setCategoryAndSubmit(categoryItem.id)">
        ...
        <div class="col-9">
            <div class="db-card">
                ...
                <div class="table-filter-div">
                    <form class="p-4 sm:p-5 mb-5" @submit.prevent="search" ref="searchForm">
                        <div class="row">
                        ...
                        <tbody class="db-table-body" v-if="items.length > 0">
                            <tr class="db-table-body-tr" v-for="item in items" :key="item">
                                ...
                                <td class="db-table-body-td">
                                    <img :src="item.thumb" alt="thumb" style="width: 80px;height:80px" />
                                </td>
                                <td class="db-table-body-td">
                                ...
                                <td class="db-table-body-td">
                                    ...
                                    <Toggle label="Toggle Switch" :value="item.status == 10 ? false : true" :item="item"
                                        :id="'cb' + item.id" :search="props" />
                                </td>
...
import Toggle from "../components/buttons/smToggleComponent.vue"
...
export default {
    ...
    methods: {
        setCategoryAndSubmit(categoryId) {
            // Set the category ID in your form data
            this.props.search.item_category_id = categoryId;
