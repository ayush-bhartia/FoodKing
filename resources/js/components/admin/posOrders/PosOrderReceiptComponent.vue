                    ...
                    <tr v-if="orderItems.length > 0" v-for="item in orderItems" :key="item">
                        ...
                        <td class="text-left font-normal align-top py-1">
                            ...
                            <p v-if="Object.keys(item.item_variations).length !== 0"
                               class="text-xs font-normal text-heading">
                            ...
                            <p v-if="item.item_extras.length > 0" class="text-xs font-normal text-heading">
                                {{ $t('label.extras') }}:
                            ...
                            <p v-if="item.instruction" class="text-xs font-normal text-heading">
                                {{ $t('label.instruction') }}: {{ item.instruction }}
                            </p>
                        </td>
                        <td class="text-right font-normal align-top">
                ...
                <div class="py-2 pl-7">
                    <table class="w-full">
                        <tr>
                            ...
                            <td class="text-xs text-right py-0.5 text-heading">{{ order.subtotal_currency_price }}</td>
                        </tr>
                        <tr>
